...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Giriş Yap — Gençlik Döngüsü" },
      { name: "description", content: "Esenler Gençlik Döngüsü hesabına giriş yap veya yeni hesap oluştur." },
    ],
  }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-md flex-col gap-6 px-4 py-6">
      ...
      <div className="anim-scale-in rounded-3xl border bg-card/80 p-6 shadow-card backdrop-blur-sm">
