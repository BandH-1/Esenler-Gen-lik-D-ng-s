...
function AuthPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-4xl flex-col gap-6 px-4 py-6">
      <Link to="/" className="anim-fade-down group hidden items-center gap-2.5 md:flex">
      ...
      <div className="grid gap-6 md:grid-cols-12 items-stretch">
        <div className="order-2 flex flex-col gap-4 justify-between rounded-3xl border bg-card/85 p-6 shadow-card backdrop-blur-sm anim-scale-in md:order-1 md:col-span-5">
          <div className="flex flex-col gap-4">
            <div className="relative aspect-square overflow-hidden rounded-2xl border bg-secondary/35 shadow-soft max-h-[220px]">
              <img
                src="https://esenler.bel.tr/wp-content/uploads/2019/05/mayor-1.jpg"
              ...
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/85 via-black/45 to-transparent p-3 text-white">
                <div className="font-display text-xs font-bold leading-none">
                  Mehmet Tevfik Göksu
                </div>
                <div className="text-[9px] opacity-90 mt-1 leading-none">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="relative rounded-xl bg-secondary/40 p-3 border border-border/50">
                <blockquote className="text-[12px] italic text-foreground/90 leading-relaxed font-medium">
                  "İnsanlar sevilmek için yaratıldılar. Eşyalar ise kullanılmak için. Dünyadaki
                  kaosun nedeni; eşyaların sevilmeleri ve insanların kullanılmalarıdır."
                </blockquote>
                <cite className="mt-1.5 block text-[10px] font-bold text-muted-foreground not-italic">
                  — Cemil Meriç
                </cite>
        ...
        <div
          className="order-1 flex flex-col justify-center rounded-3xl border bg-card/85 p-6 shadow-card backdrop-blur-sm anim-scale-in md:order-2 md:col-span-7"
        ...
        >
          ...
          >
            <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
              ...
              <path
                fill="#1976D2"
                d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.6l6.2 5.2C41.5 35.5 44 30.2 44 24c0-1.3-.1-2.4-.4-3.5z"
              />
            </svg>
            Google ile devam et
          </button>
      ...
      <p className="text-center text-[11px] text-muted-foreground">
        ...
        Hesabın belediye sistemine güvenli şekilde bağlanır. Adres, telefon ve ödeme bilgisi
        paylaşılmaz.
      </p>
