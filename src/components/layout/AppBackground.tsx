  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div
        ...
        style={{
          background: "radial-gradient(circle at 30% 30%, var(--brand-from), transparent 70%)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at 70% 40%, var(--brand-to), transparent 70%)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at 50% 50%, var(--brand-via), transparent 70%)",
